...
here::i_am("PML Presentation/Partial/comp-theory-slides.Rmd")
library(tidyverse)
...
- Methods for parallel computing differ across operating systems and 
different packages implements different methods 
...
```{r}
## multisession using two cores: default setup uses the max # of cores
